...
exports.addMembers = async (req, res) => {
  try {
    ...
    const resetPassword = sgMail.send(emailConstant.servicerApproval(data.email, { subject: "Reset Password", link: resetLink, subject: 'Reset Password', role: req.role == 'Super Admin' ? 'Admin' : req.role, servicerName: data.firstName }))
    // // Create the user
    res.send({
      code: constant.successCode,
      message: "Created Successfully"
