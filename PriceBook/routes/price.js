...
router.put("/updatePriceBook/:priceId",[verifyToken],priceController.updatePriceBookById); // update price book detail with ID
...
router.get('/getPriceBookCategory',[verifyToken],priceController.getPriceBookCat) // get price book category api
