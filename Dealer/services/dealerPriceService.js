...
module.exports = class dealerPriceService {
  ...
  static async getAllPriceBooksByFilter(query) {
    try {
  ...
  // Get dealer price details by ID
  ...
  // Upload CSV data for dealer prices
  ...
  // Find dealer prices by multiple IDs
